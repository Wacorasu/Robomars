import './index.css';
import gsap from '../components/gsap-public/src/all.js';
import ScrollTrigger from '../components/gsap-public/src/ScrollTrigger.js';
...
const spacing = 0.1,    // spacing of the cards (stagger)
	...
	cards = gsap.utils.toArray('.reward'),
...
document.querySelector(".button-arrow_right").addEventListener("click", () => scrubTo(scrub.vars.totalTime + spacing));
document.querySelector(".button-arrow").addEventListener("click", () => scrubTo(scrub.vars.totalTime - spacing));
